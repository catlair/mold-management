...
import { beltApi, beltOrderApi, beltUseApi, beltStockApi } from '@/api'
...
export const beltConfig: ModuleConfig = {
  name: '皮带管理',
  icon: Link2,
  stockType: 'belt',
  infoApi: beltApi,
  orderApi: beltOrderApi,
  useApi: beltUseApi,
  stockApi: beltStockApi,
  formFields: [
    { key: 'name', label: '名称', type: 'text', required: true },
    { key: 'machine', label: '机台', type: 'select', required: true, options: ['CNC-1', 'CNC-2', 'CNC-3', 'CNC-4'] },
