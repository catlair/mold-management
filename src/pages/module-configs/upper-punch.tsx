...
import { upperPunchApi, upperPunchOrderApi, upperPunchUseApi, upperPunchLinkApi, upperPunchStockApi } from '@/api'
...
export const upperPunchConfig: ModuleConfig = {
  name: '上冲管理',
  icon: ArrowUpFromLine,
  stockType: 'upperPunch',
  infoApi: upperPunchApi,
  orderApi: upperPunchOrderApi,
  useApi: upperPunchUseApi,
  linkApi: upperPunchLinkApi,
  stockApi: upperPunchStockApi,
  formFields: [
