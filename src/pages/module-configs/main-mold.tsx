...
import { mainMoldApi, mainMoldOrderApi, mainMoldUseApi, mainMoldLinkApi, mainMoldStockApi } from '@/api'
...
export const mainMoldConfig: ModuleConfig = {
  name: '主模具管理',
  icon: Box,
  stockType: 'mainMold',
  infoApi: mainMoldApi,
  orderApi: mainMoldOrderApi,
  useApi: mainMoldUseApi,
  linkApi: mainMoldLinkApi,
  stockApi: mainMoldStockApi,
  formFields: [
