...
import { punchApi, punchOrderApi, punchUseApi, punchLinkApi, punchStockApi } from '@/api'
...
export const punchConfig: ModuleConfig = {
  name: '冲头管理',
  icon: Wrench,
  stockType: 'punch',
  infoApi: punchApi,
  orderApi: punchOrderApi,
  useApi: punchUseApi,
  linkApi: punchLinkApi,
  stockApi: punchStockApi,
  formFields: [
