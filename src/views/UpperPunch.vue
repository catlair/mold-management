    ...
    <el-card>
      ...
      <el-tabs v-model="activeTab">
        <el-tab-pane label="上冲信息" name="info">
           <DataTable v-model:search="tableSearch" :hide-search="true" table-id="upper-punch.info" :data="upperPunchList" :loading="loading">
...
const askAgent = () => {
  router.push({ path: '/agent', query: { from: '上冲管理', table: '上冲信息表', filter: tableSearch.value, tab: activeTab.value } })
}
