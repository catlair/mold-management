    ...
    <el-card>
      ...
      <el-tabs v-model="activeTab">
        <el-tab-pane label="主模具信息" name="info">
          <el-table :data="mainMoldList" border style="width: 100%">
...
const orderForm = ref({ mainMoldId: '', quantity: 1, orderDate: '', status: '未到货', remark: '' })

const showUseDialog = ref(false)
const useForm = ref({ mainMoldId: '', user: '', quantity: 1, useDate: '', remark: '' })
