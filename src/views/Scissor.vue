    ...
    <el-card>
      ...
      <el-tabs v-model="activeTab">
        <el-tab-pane label="剪刀信息" name="info">
           <DataTable v-model:search="tableSearch" :hide-search="true" table-id="scissor.info" :data="scissorList" :loading="loading">
...
const askAgent = () => {
  router.push({ path: '/agent', query: { from: '剪刀管理', table: '剪刀信息表', filter: tableSearch.value, tab: activeTab.value } })
}
