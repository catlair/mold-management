...
pub const SHEETS: &[(&str, &[(&str, &str)])] = &[
    ...
    ("冲头信息表", &[("内部ID", "id"), ("名称", "name"), ("规格", "spec"), ("材质", "material"), ("安全库存", "safetyStock")]),
    ...
    ("牙板信息表", &[("内部ID", "id"), ("名称", "name"), ("机型", "machineType"), ("线径", "wireDiameter"), ("安全库存", "safetyStock")]),
    ...
    ("皮带信息表", &[("内部ID", "id"), ("名称", "name"), ("规格", "spec"), ("适用机器", "machine"), ("安全库存", "safetyStock")]),
    ...
    ("主模具信息表", &[("内部ID", "id"), ("名称", "name"), ("孔径", "holeDiameter"), ("对应线材", "wireMaterial"), ("安全库存", "safetyStock")]),
    ...
    ("剪刀信息表", &[("内部ID", "id"), ("名称", "name"), ("口径", "diameter"), ("对应线材", "wireMaterial"), ("安全库存", "safetyStock")]),
    ...
    ("上冲信息表", &[("内部ID", "id"), ("名称", "name"), ("口径", "diameter"), ("对应线材", "wireMaterial"), ("安全库存", "safetyStock")]),
